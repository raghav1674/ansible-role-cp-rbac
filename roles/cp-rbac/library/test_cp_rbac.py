...
class TestCPMetadataApiRequest(unittest.TestCase):
    ...
    @patch.multiple(cp_rbac.CPMetadataApiRequest,
                        basic_params=Mock(return_value=dict()),
                        url=Mock(return_value="http://localhost:8090"))
...
class TestCPMetadataApiService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.password  = "superUser"
        self.verify_ssl = False
        self.resource_role_bindings = [
            cp_rbac.ResourceRoleBinding('DeveloperRead',{
              "resourceType": "Group",
              "name": "test-*",
              "patternType": "LITERAL"}),
              cp_rbac.ResourceRoleBinding('DeveloperManage',{
              "resourceType": "Topic",
              "name": "test-*",
              "patternType": "LITERAL"})
            ]
    ...
    def test__diff_bindings_with_resource_role_bindings(self):
        ...
        expected_result = {
            "add": [],
            "remove": [self.resource_role_bindings[0]]
        }
    ...
    def test__diff_bindings_with_cluster_role_bindings(self):
        ...
        expected_result = {
            "add": [self.cluster_role_bindings[1]],
            "remove": []
        }
